...
export type ConstructorValues<
  ...
  RemovedKeys extends keyof OmitMethods<
    Omit<Entity, keyof Node<Entity>>
  > = never,
  OptionalKeys extends keyof OmitMethods<
    Omit<Entity, keyof Node<Entity> | RemovedKeys>
  > = never
> = SetOptional<
  OmitMethods<Omit<Entity, keyof Node<Entity> | RemovedKeys>>,
  OptionalKeys
>;
